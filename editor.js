...
function createEditor() {
    ...
    function guessDocUrl() {
        ...
        if (pos !== -1) {
            ...
            // Set in document body -- Øyvind
            docUrl = odfLoadUrl;
        }
        // Make random number and append to Url to disable caching
        var rand = Math.random().toString(36).substr(2);
        docUrl = docUrl + '?rand=' + rand;
        return docUrl || null;
    }
    ...
    function save() {
        function saveByteArray(err, data) {
            ...
            // Saving mechanism: using ajax and form submit 
            ...
            // commented out: saveAs(blob, filename);
    ...
    function onEditorCreated(err, e) {
        ...
        editor = e;
        editor.setUserData({
            fullName: odfEditorFullname,
            color:    odfEditorColor,
        });
        ...
        // Added by Øyvind: save with ctrl + s 
        ...
        case 's':
            ...
            // console.dir(session.getOdtDocument());
            // console.dir(editor.isDocumentModified()); 
